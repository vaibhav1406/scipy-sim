...
class Subtractor( Actor ):
    ...
    def __init__( self, input_1, input_2, output_queue, discard_incomplete_sets=True ):
        ...
        @param input_1: input queue for subtracting from.
        
        @param input_2: input queue of values to subtract
    ...
    def process( self ):
        ...
        objects = [in_queue.get( True ) for in_queue in [self.input_1, self.input_2]]
